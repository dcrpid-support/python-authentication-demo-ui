"""
Django settings for auth_demo_ui project.
...
SECRET_KEY = 'django-insecure-d&nosjplg+unw@htn)0i4e!aeyk_ofqro*1s*r1s!p3r8+rdaw'
...
ROOT_URLCONF = 'auth_demo_ui.urls'
...
WSGI_APPLICATION = 'auth_demo_ui.wsgi.application'
